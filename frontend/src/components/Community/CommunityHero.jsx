export default function CommunityHero() {
  return (
    <section className="bg-[#e0f2f1] min-h-[50vh] flex items-center justify-center px-6">
      <div className="max-w-5xl text-center">
        <h1 className="text-4xl font-bold text-[#00796b] mb-4">
          Hello And Welcome To <br /> Our Community Forum!
        </h1>
